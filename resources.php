...
<div class="signupBox container" style="margin:0 auto">
	<h1>Resources</h1>
	<p>Hello entrepreneur! This is a curated list of resources for you to use for free in order to kickstart your business, present to investors, and connect with others.</p>
	<div class="display:block">
		<a class="btn btn-primary" style="width:400px;">Contribute a Resource</a>
	</div>
	<hr>
	...
	<div class="col-md-3">
		<div class="card">
		  ...
		  <div class="card-block">
		    ...
		    <a href="#" class="btn btn-success">View</a> <a href="#" class="btn btn-primary">Download</a>
		  </div>
		</div>
	</div>
	<?php } ?>
